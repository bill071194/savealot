...
<div class="mb-4 border-bottom row">
    ...
    <div class="col-12 border-bottom">
        <div class="text-center w-100 fw-bold mt-2">Revenue Chart</div>
        <canvas class="mb-2 w-100" id="ordersChart" width="3000" height="1000" style="display: block; box-sizing: border-box; height: 301px; width: 715px;"></canvas>
    </div>
    <div class="col-12 border-bottom">
        <div class="text-center w-100 fw-bold mt-2">New Users</div>
    ...
    <div class="col-12 border-bottom">
        ...
        <canvas class="mb-2 w-100" id="transactionsChart" width="3000" height="1000" style="display: block; box-sizing: border-box; height: 301px; width: 715px;"></canvas>
    </div>
    <div class="col-12 border-bottom">
